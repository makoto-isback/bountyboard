...
export default function TaskCard({ task }: { task: ExtendedTask }) {
  ...
  return (
    <div className="group rounded-xl border border-[#1a1a1a] bg-[#111111] p-5 transition-all duration-200 hover:border-[#333] hover:bg-[#141414] card-glow">
      ...
      <div className="mt-4 flex flex-wrap items-center gap-2">
        ...
        {task.pdaAddress && (
          <a
            href={`https://solscan.io/account/${task.pdaAddress}?cluster=devnet`}
            target="_blank"
            rel="noopener noreferrer"
            className="px-2 py-0.5 rounded-md bg-blue-500/5 text-blue-400/70 hover:text-blue-400 text-xs border border-blue-500/10 transition-colors"
